        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <form class="comment-form" id="login-form" action="index.php" method="GET" role="form" style="display: block;">
              ...
              <input id="idAni" name="idAni" type="hidden" value="<?= $idAni ?>">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="category" id="category" placeholder="Categoria" value="<?= $category ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="cover" id="cover" placeholder="URL de la Caratula" value="<?= $cover ?>">
                </div>
