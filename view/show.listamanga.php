  ...
  <nav class="navbar center navbar-expand-lg">
      <div class="container flex-lg-column">
        <div class="navbar-header">
          <div class="navbar-brand"><img srcset="assets/img/mimanga.png" alt="" /></div>
            ...
            ?>
              <div class="post">
                <div class="box bg-white shadow">
                  ...
                  <span><a href="index.php?mod=user&ope=deleteman&idMan=<?=$item->getIdMan();?>&idUsu=<?php echo $_SESSION['idUsu'];?>"> Borrar</a></span>
                  </div>
                </div>
                <!-- /.box -->
              </div>
